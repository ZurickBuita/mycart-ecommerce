<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg-px-8 mx-auto">
  <section class="flex items-center font-poppins dark:bg-gray-800 p-5">
    <div
      class="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto bg-white border rounded-md border-gray-300 dark:bg-gray-900 md:py-10 md:px-10">
      <div>
        ...
        <div class="flex flex-wrap items-center pb-4 mb-10 border-b border-gray-200 dark:border-gray-700">
          ...
          <div class="w-full px-4 mb-4 md:w-1/4">
            <p class="mb-2 text-sm leading-5 text-gray-600 dark:text-gray-400 ">
              Payment Method: </p>
            <p class="text-base font-semibold leading-4 text-gray-800 dark:text-gray-400 ">
              {{ $order->payment_method == 'cash on delivery' ? 'Cash on Delivery' : 'Card'}}
            </p>
          </div>
        </div>
