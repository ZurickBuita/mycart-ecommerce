    ...
    <div class="px-4 py-4 mx-auto max-w-7xl lg:py-6 md:px-6">
      <div class="flex flex-wrap mb-24 -mx-3">
        <div class="w-full pr-2 lg:w-1/4 lg:block">
          <div class="p-4 mb-5 bg-white border border-slate-200">
            ...
            <ul>
              <li class="mb-4">
                <label for="featured" class="flex items-center">
                  ...
                  <span class="text-lg">Is Feature</span>
                </label>
              </li>
              <li class="mb-4">
            ...
            @foreach ($products as $product)
              <div wire:key="{{ $product->id }}" class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3">
                <div class="border border-slate-200">
                  ...
                  <div class="flex justify-center p-4 border-t border-slate-200">

                    <a wire:click.prevent="addToCart({{ $product->id }})" href="#"
                      class="text-gray-500 flex items-center space-x-2 hover:text-red-500 dark:hover:text-red-300">
